...
<!-- LOADING AREA  END ====== -->
	<div class="page-wraper">
      <input type="hidden" id="productCategory" value="Solar Product">
        ...
        <div class="page-content">
            ...
            <!-- INNER PAGE BANNER -->
            <div class="wt-bnr-inr overlay-wraper bg-center" style="background-image:url(images/banner/solar-product.png);">
            	<div class="overlay-main site-bg-black opacity-07"></div>
                <div class="container">
                    <div class="wt-bnr-inr-entry">
                    	<div class="banner-title-outer">
                        	<div class="banner-title-name">
                        		<h2 class="wt-title">Solar Products</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->                            
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-12 rightSidebar  m-b30">
                            ...
                            <aside  class="side-bar">
                                   ...
                                   <div class="widget widget_services p-a20">
                                    ...
                                    <ul>
                                        <li><a href="#">Solar Products</a><span class="badge"><?php echo $solar_count; ?></span></li>
